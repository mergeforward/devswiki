...
$(function () {
    ...
    if (diagram.length) {
        loadResource( '/assets/js/plugin/flowchart-js/flowchart.css', 'stylesheet', function() {
        loadResource( '/assets/js/plugin/flowchart-js/svg-innerhtml.js', 'script', function() {
